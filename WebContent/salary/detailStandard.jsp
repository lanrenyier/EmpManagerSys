...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;<a href="deptList.action.action">薪资管理</a>>>显示薪资详细信息</td>
			</tr>
		 </table>
	</div>
          ...
          <tr>
            ...
            <tr>
                ...
                <td align="left">
                 	...
                 	&nbsp;&nbsp;&nbsp;<input type="button" value="返  回" onclick="location='/EmpManageSys/salary/salaryStandardList.action'" class="buttonBack"/>
                </td>
            </tr>
        </table>
        </form>
