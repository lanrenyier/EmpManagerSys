...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;<a href="deptList.action" target="main">薪资管理</a>>>添加薪资详细信息</td>
			</tr>
		 </table>
	</div>
	<div height="100%" style="margin-top:10px;">
		<fieldset style="width:98%">
			<legend>填写薪资详情如下：</legend>
		...
		<table border="0" cellpadding="0" cellspacing="15">
            <tr>
                <td >
                    部门名称：</td>
                <td>
                   <input type="text" name="dept.name" value=""/></td>
                <td>
                    部门人数：</td>
                 <td >
                    <input type="text" name="dept.number"  /></td>
            </tr>
            <tr>
                <td>
                    部门电话：</td>
            ...
            <tr>
                ...
                <td colspan="3" style="height: 42px">
                    <textarea name="dept.remartk" rows="5" cols="54" style="border:1px solid gray;overflow: hidden;" ></textarea> </td>
            </tr>
            <tr>
                <td >&nbsp;
                </td>
