...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;<a href="attendenceList.action" target="main">考勤管理</a>>>添加考勤详细信息</td>
			</tr>
		 </table>
	</div>
          ...
          <tr>
            ...
            <tr>
                ...
                <td align="left">
                 	...
                 	&nbsp;&nbsp;&nbsp;<input type="button" value="返  回" onclick="location='/EmpManageSys/salary/attendenceList.action'" class="buttonBack"/>
                </td>
            </tr>
        </table>
        </form>
