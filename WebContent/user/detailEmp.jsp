...
<div class="table_top" style="height:100%">
	<div>
		 <table width="100%" class="top" cellpadding="0" cellspacing="0">
			<tr>
				<td class="td_top"><b>当前位置:</b>&nbsp;<a href="dept!doShowAll.action" target="main">员工管理</a>>>添加员工</td>
			</tr>
		 </table>
	</div>
		...
		<fieldset style="width:98%">
            ...
            <tr>
                ...
                <td align="left">
                 	...
                 	&nbsp;&nbsp;&nbsp;<input type="button" value="返  回"  cssClass="buttonBack"  onclick="location='/EmpManageSys/user/empList.action'" class="buttonBack"/>
                </td>
            </tr>
        </table>
     </fieldset>
