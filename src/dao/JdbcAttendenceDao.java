...
public class JdbcAttendenceDao implements AttendenceDao {
	...
	public List<Attendence> findAll(int page, int pageSize, String year,
	...
	public void save(Attendence attendence) throws Exception {
		 ...
		 * attendence.getEarlyLeave()); // pst.setFloat(8,
		 * attendence.getLeaveDays()); pst.setString(9,
		 * attendence.getTrueName()); pst.executeUpdate();
		 * DbUtil.closeConnection();
		 */
	...
	public List<Attendence> findAttendence(Attendence attendence)
		...
		if (attendence.getTrueName() != null
				&& !attendence.getTrueName().equals("")) {
	...
	public List<Attendence> showAttendence() throws Exception {
		 ...
		 * DbUtil.getConnection(); Statement stmt=conn.createStatement();
		 * ResultSet rs=stmt.executeQuery(sql); List<Attendence> list = new
		 * ArrayList<Attendence>(); while(rs.next()){ Attendence attendence =
		 * new Attendence(); attendence.setEarlyLeave(rs.getInt("earlyleave"));
		 ...
		 * list.add(attendence); } DbUtil.closeConnection();
		 */
		return null;
	}
	...
	public List<Attendence> generateByMonth(int page, int pageSize,
